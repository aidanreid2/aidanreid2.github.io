    ...
    var levelData = [
      {
        ...
        gameItems: [
          ...
          { type: "reward", x: 750, y: groundY - 40, increaseHealth : 10, velocityX : 1.3, image : "img/coin.png" , offsetX : -25, offsetY : -30, hzSize : 25, scaleX: 0.3, scaleY : 0.4}, //all settings and customizations made for the different parameters in the loop for the rewards.
          ...
          { type: "levelMarker", x: 1400, y: groundY - 100, increaseHealth : 20, velocityX : 1.5, image : "img/STAR.png" , offsetX : -25, offsetY : -30, hzSize : 25, scaleX: 0.3, scaleY : 0.4}, //all settings and customizations made for the different parameters in the loop for the levelMarker.
      ...
      },
      {
        ...
        gameItems: [
          ...
          { type: "reward", x: 1000, y: groundY - 59, increaseHealth : 10, velocityX : 1.5, image : "img/goldcoin.png" , offsetX : -25, offsetY : -30, hzSize : 25, scaleX: 0.3, scaleY : 0.4}, //all settings and customizations made for the different parameters in the loop for the rewards.
          { type: "reward", x: 1400, y: groundY - 69, increaseHealth : 50, velocityX : 1.5, image : "img/gem.png" , offsetX : -25, offsetY : -30, hzSize : 25, scaleX: 0.3, scaleY : 0.4},  //all settings and customizations made for the different parameters in the loop for the rewards.   
          { type: "reward", x: 1200, y: groundY - 69, increaseHealth : 10, velocityX : 1.5, image : "img/goldcoin.png" , offsetX : -25, offsetY : -30, hzSize : 25, scaleX: 0.3, scaleY : 0.4}, //all settings and customizations made for the different parameters in the loop for the rewards.
          ],
      },
    ];
